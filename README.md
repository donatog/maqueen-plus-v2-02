...
> Apri questa pagina in [https://donatog.github.io/maqueen-plus-v2-02/](https://donatog.github.io/maqueen-plus-v2-02/)
...
* cerca **https://github.com/donatog/maqueen-plus-v2-02** ed importa

## Modifica questo progetto ![Badge stato build](https://github.com/donatog/maqueen-plus-v2-02/workflows/MakeCode/badge.svg)

Per modificare questa repository in MakeCode.

* apri [https://makecode.microbit.org/](https://makecode.microbit.org/)
* clicca su **Importa** quindi fai clic su **Importa INDIRIZZO**
* incolla **https://github.com/donatog/maqueen-plus-v2-02** e clicca importa
...
![Un'immagine renderizzata dei blocchi](https://github.com/donatog/maqueen-plus-v2-02/raw/master/.github/makecode/blocks.png)
